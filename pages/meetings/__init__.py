...
class MeetingDetails:		# Any of these can be HTML formatted, but I'd recommend against it for semantics sake.
    ...
    def Schedule():
        ...
        schedlist.append(['7:20PM', '7:50PM', 'DEFCON 201 Annoucements & Code of Conduct',  'GI Jack & Sidpocket', 'DEFCON 201', 'DEFCON 201 will start with various updates about our activities in early 2020 and an overview of the Code of Conduct linked on our website.'])
        ...
        schedlist.append(['8:00PM', '8:10PM', '<em>An Introduction to Iot Pentetration Testing</em>',  'Libertyunix', 'DEFCON 201', 'In this talk we will explore the basic principles of IoT PenTesting, how to build an effective toolset, reverse engineering, and analyzing wireless signals with software defined radio.'])
        schedlist.append(['8:10PM', '9:55PM', 'Workshops + Projects', 'Feburary 2020', 'Open participation', 'Talk about and work together on projects! Open Projects include Lockpicking, PWNagotchi, Pi-Hole, and preparing for PAX East! We also encourage to bring your own!'])
