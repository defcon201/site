...
class MeetingDetails:		# Any of these can be HTML formatted, but I'd recommend against it for semantics sake EXCEPT where triple quotes (""" like this """) appear.
    ...
    def Summary():		# Short, 1-2 sentences about this meeting.
        return """
        Join DEFCON 201 Online via Zoom or broacasted on Twitch, dLive or youtube on Friday, April 17th starting at 7:00 PM EST [6:30 PM EST PRE-SHOW]
        to learn about agricultural and environmentally friendly hacking techniques!
        <h2><a href="https://stats.foldingathome.org/team/241960">Join the DEFCON 201 Folding@Home Team: 241960</a></h2>"""
    ...
    To add a footnote after the end of the schedule, use this template after the last entry:
        ...
        schedlist.append([
            ...
            '7:00PM',
            'Online Queue',
            'PRE-MEETING HACKER EDUTAINMENT',
            'DEFCON 201 Members',
            """To give time to make sure everyone is watching our LiveStream and logging into our LiveStream chat, DEFCON 201 will be showing various videos that relates to our meeting theme."""
            ])
        ...
        schedlist.append([
            ...
            'Mary Wetherill & Electra Jarvis',
            """Mary and Electra of Green Food Solutions, will discuss how they are empowering a new local food system, and how you can grow food practically anywhere that has access to electricity and water.
            They will also give a live demo of their home growing Tower."""
            ])
        ...
        schedlist.append([
            ...
            'BitGreen Foundation',
            """In this talk, the BitGreen Foundation will go over their future goals on the BitGreen project to fund energy efficient and tech activism,
            how their Proof Of Stake mining method differs from other cryptocurrencies and how to set up your own Master Node directly from the BitGreen Wallet to mine BitGreen on any hardware."""
            ])
        ...
        schedlist.append([
            ...
            'Chris Sanders',
            """The Rural Technology Fund (RTF) recognizes the very real “digital divide” between rural and non-rural areas."""
            ])
        ...
        schedlist.append([
            ...
            'Drinking + Games',
            'Open participation',
            """Join us in the Zoom Chat (email us for access) for our Hacker Show & Tell, Jackbox Party Games, Drinking Alcohol and Juice and 1337 converstations while we lose our minds in isolation!"""
            ])
        ...
        schedlist.append([
            ...
            'CTF',
            'PlaidCTF',
            """<a href="https://discord.gg/PGgPNEF">PlaidCTF on Discord</a><br>
            If you are new to Online CTF, we will help you get set up and walk you thorugh some of the challenges: https://plaidctf.com/"""
            ])
